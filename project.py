...
start_time = time.time()
print("-----------------------------------------")
set5 = list(random_items1 + random_items2 +
            random_items3 + random_items4 + random_items5)
print(set5)
...
start_time = time.time()
print("-----------------------------------------")
set6 = list(random_items1 + random_items2 + random_items3 +
            random_items4 + random_items5 + random_items6)
print(set6)
...
start_time = time.time()
print("-----------------------------------------")
set7 = list(random_items1 + random_items2 + random_items3 +
            random_items4 + random_items5 + random_items6 + random_items7)
print(set7)
...
start_time = time.time()
print("-----------------------------------------")
set8 = list(random_items1 + random_items2 + random_items3 + random_items4 +
            random_items5 + random_items6 + random_items7 + random_items8)
print(set8)
...
start_time = time.time()
print("-----------------------------------------")
set9 = list(random_items1 + random_items2 + random_items3 + random_items4 +
            random_items5 + random_items6 + random_items7 + random_items8 + random_items9)
print(set9)
...
start_time = time.time()
print("-----------------------------------------")
set10 = list(random_items1 + random_items2 + random_items3 + random_items4 + random_items5 +
             random_items6 + random_items7 + random_items8 + random_items9 + random_items10)
print(set10)
...
def binary_size(arr, x):
    ...
    high = len(arr) - 1
    mid = 0
    size = sys.getsizeof(arr) + sys.getsizeof(low) + \
        sys.getsizeof(high) + sys.getsizeof(mid)
    while low <= high:
        mid = (high + low) // 2
        # If x is greater, ignore left half
        if arr[mid] < x:
